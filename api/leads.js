const RECIPIENTS = [
  "rodriguesgrege@gmail.com",
  "abhishikaagarwal2023@gmail.com",
];
...
export default async function handler(request, response) {
  ...
  const html = `
    <div style="font-family:Arial,sans-serif;line-height:1.5;max-width:640px">
      ...
      <table style="border-collapse:collapse">${field("Name", name)}${field("Work email", email)}${field("Repository / org", repo)}${field("Message", message)}</table>
    </div>`;
