(()=>{
 ...
 const steps=[
  {label:'01 · CANDIDATE CARD',id:'C01 · Hypothesis',title:'Could retry lose the idempotency key?',summary:'The PR replaces the payment object. Brainstorm records a suspected loss of the original idempotency key.',json:{issue:'Possible idempotency key loss',category:'Correctness',reasoning:'Object replaced'},phase:'Brainstorm · form candidate cards'},
  {label:'02 · VALIDATED CARD',id:'C01 · Evidence attached',title:'The dependency omits idempotencyKey.',summary:'Codebase context links restore() to PAY-42: the missing key lets createPaymentIntent() generate a new one. Unsupported candidates stop here.',json:{requirement:'PAY-42: Preserve original key',dependency:'retry-state.ts',evidence:'Expected pay_9182; observed null',validated:true},phase:'Validate · check against codebase context'},
  {label:'03 · SCORED CARD',id:'C01 · Illustrative assessment',title:'A high-confidence correctness issue.',summary:'The validated finding is assessed for confidence, priority, severity and impact.',json:{confidence:'High',priority:'P1',severity:'High',impact:'Duplicate customer charges'},phase:'Score · assess the validated findings'},
  ...
  {label:'PR · REVIEWER OUTPUT',id:'C01 · Merge blocked',title:'Retry can cause duplicate charges.',summary:'The reviewer sees the root cause and impact in the PR. A Jira ticket is linked when that integration is configured.',json:{priority:'P1',confidence:'High',severity:'High',impact:'Duplicate customer charges'},phase:'Complete · findings returned to the PR'}
 ];
